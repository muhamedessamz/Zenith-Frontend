        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
            ...
            <section className="pt-40 pb-20 px-6">
                <div className="container mx-auto text-center">
                    ...
                    <h1 className="text-6xl md:text-7xl font-display font-bold mb-6 leading-tight animate-fadeIn">
                    ...
                    <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto animate-fadeIn">
                        Zenith is the ultimate task management platform that helps teams collaborate,
                        track progress, and achieve their goals faster than ever.
                    </p>
                            ...
                            <div className="bg-gradient-to-br from-slate-50 to-indigo-50 rounded-xl p-6">
                                ...
                                <div className="flex items-center justify-between mb-6">
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">Welcome back, Ahmed!</p>
                                    </div>
                                ...
                                <div className="grid grid-cols-4 gap-4 mb-6">
                                    ...
                                    <div className="bg-white rounded-lg p-4 shadow-sm">
                                        <div className="flex items-center justify-between mb-2">
                                            ...
                                            <span className="text-xs text-amber-600 font-semibold">12</span>
                                        </div>
                                    ...
                                    <div className="bg-white rounded-lg p-4 shadow-sm">
                                        <div className="flex items-center justify-between mb-2">
                                            ...
                                            <span className="text-xs text-cyan-600 font-semibold">5</span>
                                        </div>
                                ...
                                <div className="grid grid-cols-3 gap-4">
                                    ...
                                    <div className="col-span-2 bg-white rounded-lg p-4 shadow-sm">
                                        ...
                                        <div className="flex items-end justify-between h-32 gap-2">
                                            <div className="flex-1 bg-gradient-to-t from-indigo-500 to-indigo-400 rounded-t" style={{ height: '60%' }}></div>
                                            <div className="flex-1 bg-gradient-to-t from-indigo-500 to-indigo-400 rounded-t" style={{ height: '80%' }}></div>
                                            <div className="flex-1 bg-gradient-to-t from-indigo-500 to-indigo-400 rounded-t" style={{ height: '45%' }}></div>
                                            <div className="flex-1 bg-gradient-to-t from-indigo-500 to-indigo-400 rounded-t" style={{ height: '90%' }}></div>
                                            <div className="flex-1 bg-gradient-to-t from-indigo-500 to-indigo-400 rounded-t" style={{ height: '70%' }}></div>
                                            <div className="flex-1 bg-gradient-to-t from-cyan-500 to-cyan-400 rounded-t" style={{ height: '95%' }}></div>
                                            <div className="flex-1 bg-gradient-to-t from-cyan-500 to-cyan-400 rounded-t" style={{ height: '85%' }}></div>
                                        </div>
                                    </div>

                                    {/* Recent Tasks */}
                                    <div className="bg-white rounded-lg p-4 shadow-sm">
                                        <h4 className="font-semibold text-gray-700 mb-3">Recent Tasks</h4>
                                        <div className="space-y-3">
                                            <div className="flex items-center gap-2">
                                                <div className="w-2 h-2 rounded-full bg-green-500"></div>
                                                <div className="flex-1">
                                                    <p className="text-xs font-medium text-gray-700">Design Review</p>
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                <div className="flex-1">
                                                    <p className="text-xs font-medium text-gray-700">API Integration</p>
                                            ...
                                            <div className="flex items-center gap-2">
                                                <div className="w-2 h-2 rounded-full bg-indigo-500"></div>
                                                <div className="flex-1">
                                                    <p className="text-xs font-medium text-gray-700">Team Meeting</p>
                                            ...
                                            <div className="flex items-center gap-2">
                                                <div className="w-2 h-2 rounded-full bg-green-500"></div>
                                                <div className="flex-1">
                                                    <p className="text-xs font-medium text-gray-700">Code Review</p>
                                                    <p className="text-xs text-gray-400">Completed</p>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div className="container mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                            Powerful features designed to help you and your team reach new heights
                        </p>
                    </div>
            ...
            {/* How It Works */}
            <section id="how-it-works" className="py-20 px-6 bg-gradient-to-br from-indigo-50 to-cyan-50 scroll-mt-20">
                <div className="container mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl md:text-5xl font-display font-bold mb-4">
                            Simple, Yet <span className="gradient-text">Powerful</span>
                        </h2>
                        <p className="text-xl text-gray-600">Get started in minutes, master in hours</p>
                    </div>
            ...
            {/* CTA Section */}
            <section id="pricing" className="py-20 px-6 bg-gradient-to-br from-indigo-600 to-cyan-600 text-white scroll-mt-20">
                <div className="container mx-auto text-center">
                    ...
                    <Link to="/register" className="btn bg-white text-indigo-600 hover:bg-gray-100 text-lg px-8 py-4 shadow-xl">
                        Start Free Trial
                        <ArrowRight size={20} />
                    </Link>
                </div>
...
const features = [
    {
        ...
        description: 'Complete CRUD operations with filters, priorities, categories, and tags for perfect organization.'
    },
    {
        icon: Users,
        title: 'Team Collaboration',
        description: 'Multi-user assignments, real-time updates, comments, and shared workspaces.'
    },
    {
        icon: Kanban,
        title: 'Multiple Views',
        description: 'Kanban boards, Calendar view, List view, and Dashboard for flexible workflow visualization.'
    },
    {
        icon: Clock,
        title: 'Time & Progress',
        description: 'Built-in time tracking, task dependencies, checklists, and detailed analytics.'
    },
    {
        icon: Calendar,
        title: 'Smart Integration',
        description: 'Google Calendar sync, file attachments, shared links, and real-time notifications.'
    },
    {
        icon: Shield,
        title: 'Enterprise Ready',
        description: 'Secure authentication, encrypted data, role-based access, and 99.9% uptime.'
    }
];
