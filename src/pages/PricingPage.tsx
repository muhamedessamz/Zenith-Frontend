                    ...
                    <nav className="container mx-auto px-6">
                        <div className="flex items-center justify-between h-20">
                            ...
                            <div className="hidden md:flex items-center gap-8 absolute left-1/2 transform -translate-x-1/2">
                                ...
                                <Link to="/features" className="text-sm font-medium text-gray-700 hover:text-indigo-600 transition">
                                    Features
                                </Link>
                                <Link to="/#how-it-works" className="text-sm font-medium text-gray-700 hover:text-indigo-600 transition">
                                    How It Works
                                </Link>
                                <Link to="/pricing" className="text-sm font-medium text-indigo-600 border-b-2 border-indigo-600 pb-1">
                                    Pricing
                                </Link>
                            </div>
            ...
            <main className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <p className="text-xl text-gray-600 mb-8">
                        Choose the perfect plan for you and your team. No hidden fees. Cancel anytime.
                    </p>
                    ...
                    <div className="flex items-center justify-center gap-4">
                        ...
                        <button
                            ...
                            className="relative w-14 h-8 bg-indigo-600 rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                        >
                            <span
                                className={`absolute left-1 top-1 bg-white w-6 h-6 rounded-full transition-transform transform ${isAnnual ? 'translate-x-6' : 'translate-x-0'
                                    }`}
                            />
                        </button>
                        <span className={`text-sm font-medium ${isAnnual ? 'text-gray-900' : 'text-gray-500'}`}>
                            Annual <span className="text-indigo-600 font-bold ml-1">(Save 20%)</span>
                        </span>
                    </div>
                </div>
                ...
                <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-8 items-start">
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-xl transition-all relative">
                        ...
                        <p className="text-gray-500 text-sm mb-6">Perfect for individuals and hobbyists.</p>
                        <div className="mb-6">
                            <span className="text-4xl font-bold">$0</span>
                            <span className="text-gray-500">/month</span>
                        </div>
                        <Link to="/register" className="btn w-full bg-indigo-50 text-indigo-700 hover:bg-indigo-100 border-none mb-8">
                            Get Started
                        </Link>
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-xl border-2 border-indigo-600 relative transform md:-translate-y-4">
                        ...
                        <Link to="/register" className="btn w-full btn-primary mb-8 shadow-lg shadow-indigo-200">
                            Start Free Trial
                        </Link>
                        <ul className="space-y-4 text-sm text-gray-600">
                            ...
                            {freeFeatures.map((feature, i) => (
                                <li key={i} className="flex items-start gap-3 text-gray-400">
                                    <Check size={18} className="text-indigo-200 flex-shrink-0 mt-0.5" />
                                    <span>{feature}</span>
                                </li>
                            ))}
                        </ul>
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-xl transition-all">
                        ...
                        <p className="text-gray-500 text-sm mb-6">Advanced security and control for large organizations.</p>
                        <div className="mb-6">
                            <span className="text-4xl font-bold">Custom</span>
                        </div>
                        <Link to="/contact" className="btn w-full bg-white text-gray-900 border border-gray-200 hover:bg-gray-50 mb-8">
                            Contact Sales
                        </Link>
                        <ul className="space-y-4 text-sm text-gray-600">
...
const faqs = [
    {
        ...
        answer: 'Yes, you can cancel your subscription at any time. We do not lock you into long-term contracts unless you choose the annual plan.'
    },
    {
    ...
    },
    {
        ...
        answer: 'Your data will be preserved, but you may lose access to paid features. You can always re-upgrade later to regain access.'
    },
    {
        question: 'Do you offer discounts for non-profits?',
        answer: 'Yes, we offer a 50% discount for registered non-profit organizations. Contact our sales team for more details.'
    }
];
